...
local function Y(e)
local i,o,t,a=1,1,1,1
if e==nil then
return{top=i,right=o,bottom=t,left=a}
end
if type(e)=="number"then
local e=math.max(0,math.floor(e))
i,o,t,a=e,e,e,e
...
i=e.maximizeButton or(type(t)=="table"and t.maximize)or nil
a=e.minimizeButton or(type(t)=="table"and t.minimize)or nil
end
return{
close=n("close",o),
maximize=n("maximize",i),
minimize=n("minimize",a)
}
end
...
local s=a.background or s or e.black
...
local function C(s,n,a,t,r,l,u,e)
...
local i=math.max(0,(r or 0)-(l or 0))
if i<=0 or t<=0 then
return
end
...
local function U(i,t,e,o,a)
if t<=0 then
return a or 0
end
local e=math.max(0,(e or 0)-(o or 0))
if e<=0 then
return 0
end
...
local function n(h,s,n,e,t,i,o,a)
if e<=0 or t<=0 then
return
end
local a=a or" "
...
local function E(n,o,a,e,i)
if e<=0 or i<=0 then
return
end
local t=X.transparent
for e=0,e-1 do
n.pixel(o+e,a,t)
if i>1 then
n.pixel(o+e,a+i-1,t)
...
local function v(s,t,a,o,i,e,h)
if o<=0 or i<=0 then
return
end
local n=e.color
...
function r:_renderLine(s,i,n,t,e,a,o)
if t<=0 then
return
end
local e=e or""
...
local h,r,a,o=self:getAbsoluteRect()
if a<=0 or o<=0 then
return
end
...
local o=math.max(0,o-n-c)
local n=e+(self.paddingLeft or 0)
...
local o=t(a.width,"width")
local t=t(a.height,"height")
...
function s:containsPoint(a,e)
local t,o,i,n=self:getAbsoluteRect()
return a>=t and a<t+i and e>=o and e<o+n
end
function s:draw(e,e)
...
local s,o,i,a=self:getAbsoluteRect()
...
h.text(s,a,e,self.fg,t)
end
end
if self.border then
v(r,s,o,i,a,self.border,t)
end
...
local t=M(e.x or self.x)
local a=M(e.y or self.y)
local o=math.max(1,M(e.width or self.width))
local e=math.max(1,M(e.height or self.height))
if t~=self.x or a~=self.y then
s.setPosition(self,t,a)
end
...
local r=i
local t=r-a+1
local s={x1=t,y1=s,x2=r,y2=s,width=a,height=h}
e.buttonRects[o]=s
e.buttonOrder[#e.buttonOrder+1]=o
e.buttonMetrics[o]={style=n,padding=d,width=a}
i=t-l-1
return s
end
...
function i:_drawTitleButton(d,m,o,r,l,u)
local e=o.buttonRects and o.buttonRects[r]
if not e then
return
end
local t=o.buttonMetrics and o.buttonMetrics[r]
if not t then
return
end
local a=t.style or{}
...
local a=s or u or self.bg or self.app.background
n(d,e.x1,e.y1,e.width,o.barHeight,a,a)
...
d.text(o,e.y1,t,h or l,a)
end
end
function i:_fillTitleBarPixels(t,e,i)
...
function i:_updateDragPosition(e,i)
...
local h=o
local s=i
local n=o+math.max(0,t.width-self.width)
...
local u,c,s,c,i,t=self:_computeInnerOffsets()
local u=r+u
local c=h+s
...
if t<r or t>l or e<u or e>m then
return
end
h(t,e,a)
end
...
local a,e,o,e,t,n=self:_computeInnerOffsets()
local e=self:_getVisibleTitleBarHeight()
local i=math.max(1,t)
local t=math.max(1,n-e)
local n=a+1
local s=o+e+1
...
local i=math.max(0,t-o-1)
if a>i then
a=i
end
e=math.max(1,t-o-a)
end
self._buttonRowY=s+e+a
else
self._buttonRowY=nil
end
self._contentFrame:setPosition(n,s)
self._contentFrame:setSize(i,math.max(1,e))
local o=math.max(1,i-self.messagePaddingX*2)
...
o=n+math.max(0,math.floor((i-t)/2))
end
local t=o
local o=self._buttonRowY or(s+e)
for e=1,a do
local e=self._buttons[e]
local e=e.button
...
local s,o,t,a=self:getAbsoluteRect()
...
function _:isWrapping()
return self.wrap
end
function _:setHorizontalAlign(e)
if e==nil then
e="left"
else
t(1,e,"string")
...
function _:setSize(t,e)
s.setSize(self,t,e)
self:_updateLines(true)
end
function _:setBorder(e)
s.setBorder(self,e)
self:_updateLines(true)
end
function _:draw(d,c)
...
function g:setColors(e,a,o,i,h,s,n)
if e~=nil then
t(1,e,"number")
self.trackColorOn=e
end
...
local t,o,a,s=self:getAbsoluteRect()
local i=self.bg or e.black
local y=self.fg or e.white
n(l,t,o,a,s,i,i)
E(l,t,o,a,s)
if self.border then
v(d,t,o,a,s,self.border,i)
end
local a,r,s,r,i,h=V(self)
if i<=0 or h<=0 then
return
end
local a=t+a
...
local a,t,i,s=self:getAbsoluteRect()
...
local i,s,a,o=self:getAbsoluteRect()
if a<=0 or o<=0 then
return
end
if self.clear then
...
h.text(i+n-1,s+r-1,e,d or u,c or l)
end
t.pixel=function(e,h,n)
local t=math.floor(e or 1)
local e=math.floor(h or 1)
if t<1 or t>a or e<1 or e>o then
return
end
d.pixel(i+t-1,s+e-1,n or u)
end
self._ctx=t
self.onDraw(self,t)
end
if self.border then
v(d,i,s,a,o,self.border,self.bg or self.app.background or e.black)
end
end
function l:new(i,a)
a=a or{}
...
local i=math.abs(t-o)
local s=math.abs(t-n)
if i==s then
if t>n then
e="upper"
elseif t<o then
...
n(i,u,l,r,d,s,s)
E(i,u,l,r,d)
local o,c,t,h=self:_getInnerMetrics()
if t<=0 or h<=0 then
if self.border then
v(f,u,l,r,d,self.border,s)
end
return
end
local a
...
n(i,o,a,t,1,self.trackColor,self.trackColor)
local c
if self:isFocused()then
...
local s=t-e+1
if s>0 then
n(i,o+e,a,s,1,self.fillColor,self.fillColor)
end
h(e,"lower")
h(t,"upper")
else
...
local t=e+1
if t>0 then
n(i,o,a,t,1,self.fillColor,self.fillColor)
end
h(e,"single")
end
...
i.text(t,m,a,self.fg or e.white,s)
end
end
if self.border then
v(f,u,l,r,d,self.border,s)
...
local t,n=W(self.scrollbar,#self._rows,r,e)
...
local l,m,c,f=self:getAbsoluteRect()
...
local n=s>0 and math.min(s-1,math.floor(s/2))or 0
local n=p+n
...
C(a,t.scrollbarX,p,s,#self._rows,s,e,r)
end
end
if self.border then
v(b,l,m,c,f,self.border,h)
...
local e,n=W(self.scrollbar,#self._flatNodes,a,t)
...
local h=-math.abs(i-t)
local d=t<i and 1 or-1
local e=s+h
while true do
r.pixel(a,t,n)
if a==o and t==i then
...
local a,o,h,r=self:getAbsoluteRect()
local i=self.bg or e.black
local f=self.fg or e.white
n(d,a,o,h,r,i,i)
E(d,a,o,h,r)
if self.border then
v(p,a,o,h,r,self.border,i)
end
local t=self.border
...
local a=s+math.floor((a-#o)/2)
if a<s then
a=s
end
local t=y+math.floor((t-1)/2)
d.text(a,t,o,e.lightGray,i)
end
return
end
local o=(self.showLabels and t>=2)and 1 or 0
local h=(self.showAxis and(t-o)>=2)and 1 or 0
local l=t-h-o
if l<1 then
l=t
h=0
...
local h={}
for o=1,r do
local t=s+math.floor((o-1)*a/r)
local e=s+math.floor(o*a/r)-1
if e<t then
e=t
end
if e>s+a-1 then
...
local t=a[e-1]
local e=a[e]
M(p,t.x,t.y,e.x,e.y,self.lineColor or f)
end
for o=1,#a do
local t=a[o]
...
d.text(t.x,t.y,n,a,i)
end
end
if w then
n(d,s,w,a,1,i,i)
local e=string.rep("-",a)
d.text(s,w,e,self.axisColor or f,i)
end
if u then
n(d,s,u,a,1,i,i)
...
local a,s,e,s,t,i=self:_getInnerMetrics()
local o=o+a
local s=n+e
if t<=0 or i<=0 then
return{
...
local e,n=W(self.scrollbar,#self.items,i,t)
if e>0 and t-e<1 then
e=math.max(0,t-1)
if e<=0 then
e=0
...
local s,t,o,i=self:getAbsoluteRect()
local d=self.bg or e.black
local u=self.fg or e.white
n(a,s,t,o,i,d,d)
E(a,s,t,o,i)
if self.border then
v(h,s,t,o,i,self.border,d)
end
local t=self:_computeLayoutMetrics()
...
function j:_drawDropdown(h,c)
if not self._open or#self.items==0 or self.visible==false then
return
end
local s,a,t,e=self:getAbsoluteRect()
local a=a+e
local l=#self.items
local e=self.border
...
local n,o,i,s=self:getAbsoluteRect()
local e=self.border
local t=(e and e.left)and 1 or 0
...
local a=self.tabs[i]
local a=a and a.label and tostring(a.label)or string.format("Tab %d",i)
...
n(i,t.x1,t.y1,t.width,e.tabHeight,a,a)
local r=math.max(0,self.tabPadding or 0)
...
local e,a=W(self.scrollbar,#self._lines,s,t)
if e>0 and t-e<1 then
...
return self:_collectRange(o,t,e,a)
end
...
function o:_buildLineSegments(s,i,h,r,e)
...
local f=self.app and self.app.root and self.app.root.height or(c+s)
local h=h
if h+s-1>f then
local e=c-s
if e>=1 then
...
local c,m,f,y=self:getAbsoluteRect()
local h=self.bg or e.black
...
a.text(r,n,string.rep(" ",i),w,l)
else
local h,s,d=self:_buildLineSegments(o,i,w,l,g)
...
self:_drawFindOverlay(a,r,s,i,q)
if b then
local t=o.scrollbarX
local e=b.background or h
n(a,t,s,u,d,e,e)
C(a,t,s,d,#self._lines,d,self._scrollY,b)
if p>0 then
n(a,t,s+d,u,p,e,e)
end
elseif u>0 then
n(a,o.scrollbarX,s,u,d+p,h,h)
end
if self.border then
v(j,c,m,f,y,self.border,h)
end
end
...
local u=t.add_text_layer(10,"pixelui_ui")
local d,r=o.getSize()
local n=a.background or e.black
t.fill(n)
local l=math.max(.01,a.animationInterval or .05)
